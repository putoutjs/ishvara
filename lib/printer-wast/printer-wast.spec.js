...
import {print} from './printer-wast.js';
...
test('ishvara: convert-jasm-to-wast: import: no args', (t) => {
    const source = montag`
         __ishvara_wast_import('console', 'log', function log() {
             return i32;
         });
    `;
    ...
    const expected = montag`
        (module
            (import "console" "log" (func $log (result i32)))
        )\n
    `;
