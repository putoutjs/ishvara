...
test('ishvara: plugin-fasm: convert-if-to-jmp: transform: label', (t) => {
    t.transform('label');
    t.end();
});

test('ishvara: plugin-fasm: convert-if-to-jmp: transform: more', (t) => {
    t.transform('more');
    t.end();
});
...
test('ishvara: plugin-fasm: convert-if-to-jmp: transform: less-equal', (t) => {
